/**
 * Renders /cv-pdf in headless Chrome and writes public/Diba-Malikzadeh-CV.pdf,
 * so the downloadable file is exactly the CV the site displays.
 *
 *   npm run cv:pdf
 *
 */
...
const PAGE_URL = `http://localhost:${PORT}/cv-pdf`;
const OUTPUT = "public/Diba-Malikzadeh-CV.pdf";
