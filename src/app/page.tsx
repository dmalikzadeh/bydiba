      ...
      <main className="z-10 max-w-4xl min-h-screen flex flex-col gap-12 justify-between items-center px-4 sm:px-8 md:px-12 py-12 ">
        ...
        <div className="flex flex-col md:flex-row gap-20">
          <div className="flex-2 flex flex-col gap-4">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 md:mb-8 text-balance">
              Hi, I&apos;m Diba. Full-Stack & AI Developer.
            </h1>
            <p className="text-xl md:text-2xl text-neutral-700 text-balance">
          ...
          <div className="flex-1">
            <h2 className="text-sm md:text-base uppercase text-neutral-600 mb-6 md:mb-8 font-light tracking-wider">
              Selected Projects
            </h2>
